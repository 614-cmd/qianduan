...
public class AddSequenceMultiInstanceCmd implements Command<Void> {
    ...
    public AddSequenceMultiInstanceCmd(String executionId, String assigneeList, List<String> assignees) {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        if (entity.getVariable( FlowableConstant.NUMBER_OF_INSTANCES) instanceof Integer nrOfInstances) {
