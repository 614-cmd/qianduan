...
public class FormJsonUtils {
    ...
    public boolean isBasicField(String field) {
        if ( !field.equalsIgnoreCase ( TableColumn.ID )
                && !field.equalsIgnoreCase ( TableColumn.CREATE_BY_ID )
                && !field.equalsIgnoreCase ( TableColumn.CREATE_TIME )
                && !field.equalsIgnoreCase ( TableColumn.UPDATE_BY_ID )
                && !field.equalsIgnoreCase ( TableColumn.UPDATE_TIME )
