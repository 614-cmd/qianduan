            ...
            if ( mappedStatementId.equals ( dataRule.getClassName ( ) ) ) {
                ...
                try {
                    ...
                    if ( dataRule.getSqlSegment ( ) != null ) {
                        ...
                        String[] objStrs = {"@currentUser.name","@currentUser.id","@currentUser.loginName","@currentUser.no","@currentUser.companyDTO.name", "@currentUser.companyDTO.id", "@currentUser.officeDTO.name","@currentUser.officeDTO.id", "@currentUser.companyDTO.parentIds", "@currentUser.officeDTO.parentIds"};
