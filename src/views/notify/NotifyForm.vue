	...
	<div>
		...
		>
			<el-form
				...
				v-loading="loading"
				:class="
					method === 'view' || method === 'read' ? 'readonly' : ''
				"
				:disabled="method === 'view' || method === 'read'"
			...
			>
				<el-row :gutter="15">
					...
					<el-col :span="24">
						...
						>
							<user-select
								v-model="inputForm.notifyRecordIds"
							></user-select>
						</el-form-item>
					</el-col>
					<el-col
						:span="24"
						v-if="method === 'view' && inputForm.status === '1'"
					>
