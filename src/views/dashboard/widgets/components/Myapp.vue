<template>
	<el-card shadow="never" style="height: 100%" header="我的常用">
		<div>
			<ul class="myMods">
				<li
					v-for="mod in myMods"
					:key="mod.path"
					:style="{ background: mod.meta.color || '#6ab3fb' }"
				>
					<a
						v-if="mod.meta.type == 'link'"
						:href="mod.path"
						target="_blank"
					>
						<el-icon
				...
				<div class="setMods">
					...
					>
						<template #item="{ element }">
							<li
								:style="{
									background: element.meta.color || '#6ab3fb',
								}"
							>
								<el-icon
									><component
