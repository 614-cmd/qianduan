...
public class LoginController {
    ...
    public ResponseEntity login(@RequestBody LoginForm loginForm) {
        ...
        if ( !code.equalsIgnoreCase ( RedisUtils.getInstance ( ).get ( CacheNames.SYS_CACHE_CODE, loginForm.getUuid ( ) ).toString () ) ) {
        ...
        try {
            ...
            return ResponseEntity.badRequest ( ).body ( ErrorConstants.LOGIN_ERROR_INCORRECT );
        }catch (Exception e ) {
...
//                SecurityUtils.login (userDTO.getLoginName (), userDTO.getPassword (), authenticationManager  );
    ...
    private void updateUserLoginInfo(ResponseUtil responseUtil, UserDTO userDTO, String token) {
        ...
        userDTO.setLoginIp (  RequestUtils.getRequest ( ).getRemoteAddr ());
