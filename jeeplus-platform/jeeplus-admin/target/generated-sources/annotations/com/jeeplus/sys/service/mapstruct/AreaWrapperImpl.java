...
public class AreaWrapperImpl implements AreaWrapper {
    ...
    public Area toEntity(AreaDTO dto) {
        ...
        area.setCreateById( dtoCreateById( dto ) );
        area.setUpdateById( dtoUpdateById( dto ) );
        area.setId( dto.getId() );
        area.setCreateTime( dto.getCreateTime() );
        area.setUpdateTime( dto.getUpdateTime() );
    ...
    public AreaDTO toDTO(Area entity) {
        ...
        areaDTO.setCreateTime( entity.getCreateTime() );
        areaDTO.setUpdateTime( entity.getUpdateTime() );
    ...
    public Area copyEntity(Area entity) {
        ...
        area.setCreateTime( entity.getCreateTime() );
        area.setCreateById( entity.getCreateById() );
        area.setUpdateTime( entity.getUpdateTime() );
        area.setUpdateById( entity.getUpdateById() );
    ...
    public AreaDTO copyDTO(AreaDTO dto) {
        ...
        areaDTO.setCreateTime( dto.getCreateTime() );
        areaDTO.setCreateBy( dto.getCreateBy() );
        areaDTO.setUpdateTime( dto.getUpdateTime() );
    ...
    @Override
    public DragNode<Area> toEntity(DragNode<AreaDTO> dDragDTO) {
        if ( dDragDTO == null ) {
            return null;
        }

        DragNode<Area> dragNode = new DragNode<Area>();
    ...
    protected UserDTO areaToUserDTO(Area area) {
        ...
        userDTO.setId( area.getCreateById() );
    ...
    protected UserDTO areaToUserDTO1(Area area) {
        ...
        userDTO.setId( area.getUpdateById() );
