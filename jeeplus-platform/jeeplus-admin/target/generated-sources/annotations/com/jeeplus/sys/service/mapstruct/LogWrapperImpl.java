...
public class LogWrapperImpl implements LogWrapper {
    ...
    public Log toEntity(LogDTO dto) {
        ...
        log.setCreateById( dtoCreateById( dto ) );
        log.setUpdateById( dtoUpdateById( dto ) );
        log.setId( dto.getId() );
    ...
    public LogDTO toDTO(Log entity) {
        ...
        logDTO.setUpdateTime( entity.getUpdateTime() );
        ...
        logDTO.setCreateTime( entity.getCreateTime() );
    ...
    protected UserDTO logToUserDTO(Log log) {
        ...
        userDTO.setId( log.getCreateById() );
    ...
    protected UserDTO logToUserDTO1(Log log) {
        ...
        userDTO.setId( log.getUpdateById() );
